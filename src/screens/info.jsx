...
function HelpScreen({ pc, sc, settings, onBack }) {
  const sections = [
    ...
    { icon: "📱", title: "התפריט התחתון", text: "הלשוניות נמצאות בתחתית המסך: נוכחות, לוח, תוצאות וצ'אט. לחצי על 'עוד' כדי להגיע לסקרים ולתמונות. נקודה אדומה על הצ'אט = הודעות חדשות." },
