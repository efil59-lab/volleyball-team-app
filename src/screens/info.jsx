...
function HelpScreen({ pc, sc, settings, onBack }) {
  const sections = [
    ...
    { icon: "🔔", title: "תזכורות לטלפון", text: "בלשונית 'נוכחות' יש כרטיס 'תזכורות לטלפון' — לחצי 'הפעילי' ואשרי התראות. תקבלי תזכורת בערב שלפני ובבוקר של כל אימון/משחק אם טרם אישרת הגעה, והתראה מיידית אם אירוע בוטל. באייפון: קודם התקיני את האפליקציה למסך הבית (כפתור שיתוף ← הוסף למסך הבית) ורק אז הפעילי." },
