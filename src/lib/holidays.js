...
const HOLIDAYS = [
  ...
  // בלי ספירה לאחור. יומיים לפני ערב החג: כ״ז–כ״ח באלול, ואז ערב החג עצמו.
  // רק ראש השנה מקבל ימים מראש — לשאר החגים לא נהוג לברך לפני.
  { key: "pre-rosh", kind: "hag", match: (h) => h.m === "Elul" && h.d >= 27 && h.d <= 28,
